...
public class MainActivityOLD extends AppCompatActivity implements MessageDialogFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(MainActivityOLD.this);
